...
public class StartMain {
    public static void main(String args[]){
        ...
        System.out.println("나사장 게임이 처음인가요~~??\n1. 처음이예요\n2. 처음이 아니예요");
        if(answer.nextInt() == 1){
            System.out.println("게임이 처음이라면 먼저 레시피를 봐보도록 해요!\n" +
        ...
        System.out.println("마트 주인 : 나사장님 오늘도 장보러 오셨군요! 오늘은 어떤 재료를 드릴까?\n" +
                "(원하는 재료랑 갯수를 입력하고 엔터를 쳐주세요! 모든 재료를 다 샀다면 숫자 '완료' 라고 말씀해주세요!!)");
